  ...
  render: () => <div style={{
    ...
    gap: '32px'
      ...
      <div>
        ...
        <div>
          <Timestamp value="2026-02-19T17:00:00Z" format="relative" hasCopyableEntries tooltipEntries={[{
          label: 'Local'
        }, {
          timezoneID: 'UTC',
          label: 'UTC'
      ...
      <div>
        ...
        <div>
          <Timestamp value="2026-02-19T17:00:00Z" format="relative" hasCopyableEntries />
        </div>
      </div>
    </div>
...
}`,...w.parameters?.docs?.source}}},T=[`Default`,`RelativeFormat`,`DateFormat`,`DateLongFormat`,`DateWeekdayFormat`,`DateTimeFormat`,`DateTimeWithTimezone`,`TimeFormat`,`TooltipTimezones`,`CopyableHoverCard`,`SystemFormats`,`AllFormats`,`LiveUpdating`,`TextTypes`,`Colors`,`AutoFormat`,`FutureDates`]}))();export{y as AllFormats,C as AutoFormat,S as Colors,_ as CopyableHoverCard,u as DateFormat,d as DateLongFormat,p as DateTimeFormat,m as DateTimeWithTimezone,f as DateWeekdayFormat,c as Default,w as FutureDates,b as LiveUpdating,l as RelativeFormat,v as SystemFormats,x as TextTypes,h as TimeFormat,g as TooltipTimezones,T as __namedExportsOrder,s as default};