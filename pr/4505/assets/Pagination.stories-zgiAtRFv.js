import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{o as i}from"./i18n-pYslzOoc.js";import{Ut as a,Wt as o,u as s}from"./iframe-CjmYsm03.js";function c(e){let[t,n]=(0,l.useState)(e.page??1),[r,i]=(0,l.useState)(e.pageSize??10);return(0,u.jsx)(o,{...e,page:t,onChange:n,pageSize:r,onPageSizeChange:e.pageSizeOptions?i:void 0})}var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j;e((()=>{l=t(n()),a(),s(),u=r(),d={title:`Core/Pagination`,component:o,tags:[`autodocs`],argTypes:{page:{control:`number`,description:`Current page (1-based)`},variant:{control:`select`,options:[`pages`,`count`,`compact`,`dots`,`input`,`none`],description:`Visual variant`},valueUnit:{control:`select`,options:[`page`,`row`],description:`input variant: value means 'page' or 'row'`},hasFirstLast:{control:`boolean`,description:`input variant: show first/last («/») buttons`},size:{control:`select`,options:[`sm`,`md`],description:`Size variant`},siblingCount:{control:`number`,description:`Pages shown around current page`},isDisabled:{control:`boolean`,description:`Disabled state`}}},f={render:()=>(0,u.jsx)(c,{page:1,totalItems:100,pageSize:10})},p={name:`Right to Left (RTL)`,render:()=>(0,u.jsx)(i,{locale:`en`,dir:`rtl`,children:(0,u.jsx)(`div`,{dir:`rtl`,children:(0,u.jsx)(c,{page:1,totalItems:100,pageSize:10})})})},m={name:`Variant: Pages`,render:()=>(0,u.jsx)(c,{page:1,totalItems:200,pageSize:10,variant:`pages`})},h={name:`Variant: Count`,render:()=>(0,u.jsx)(c,{page:1,totalItems:200,pageSize:20,variant:`count`})},g={name:`Variant: Compact`,render:()=>(0,u.jsx)(c,{page:1,totalPages:10,variant:`compact`})},_={name:`Variant: Dots`,render:()=>(0,u.jsx)(c,{page:1,totalPages:8,variant:`dots`})},v={name:`Variant: None`,render:()=>(0,u.jsx)(c,{page:1,totalPages:5,variant:`none`})},y={name:`Variant: Input (page mode)`,render:()=>(0,u.jsx)(c,{page:3,totalItems:200,pageSize:10,variant:`input`})},b={name:`Variant: Input (row mode)`,render:()=>(0,u.jsx)(c,{page:3,totalItems:200,pageSize:10,variant:`input`,valueUnit:`row`,onRowNavigate:e=>console.log(`navigate to row`,e)})},x={name:`Variant: Input (no first/last)`,render:()=>(0,u.jsx)(c,{page:3,totalItems:200,pageSize:10,variant:`input`,hasFirstLast:!1})},S={name:`Variant: Input (custom formatLabel)`,render:()=>(0,u.jsx)(c,{page:3,totalItems:200,pageSize:20,variant:`input`,formatLabel:(e,t)=>(0,u.jsxs)(u.Fragment,{children:[t,` / `,e.pageCount,` · rows `,e.rowStart,`–`,e.rowEnd,` of`,` `,e.totalItems]})})},C={name:`With Page Size Selector`,render:()=>(0,u.jsx)(c,{page:1,totalItems:200,pageSize:10,pageSizeOptions:[10,20,50],variant:`count`})},w={name:`Cursor-Based (hasMore)`,render:()=>(0,u.jsx)(c,{page:1,hasMore:!0})},T={name:`Small Size`,render:()=>(0,u.jsx)(c,{page:1,totalItems:100,pageSize:10,size:`sm`})},E={name:`Many Pages (Ellipsis)`,render:()=>(0,u.jsx)(c,{page:5,totalItems:500,pageSize:10})},D={name:`Many Pages (siblingCount=2)`,render:()=>(0,u.jsx)(c,{page:10,totalItems:500,pageSize:10,siblingCount:2})},O={name:`Single Page`,render:()=>(0,u.jsx)(c,{page:1,totalPages:1})},k={render:()=>(0,u.jsx)(c,{page:3,totalPages:10,isDisabled:!0})},A={name:`All Variants`,render:()=>(0,u.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:24},children:[(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{style:{marginBottom:8,fontWeight:500},children:`pages (default)`}),(0,u.jsx)(c,{page:3,totalItems:100,pageSize:10,variant:`pages`,label:`Pages variant`})]}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{style:{marginBottom:8,fontWeight:500},children:`count`}),(0,u.jsx)(c,{page:3,totalItems:100,pageSize:10,variant:`count`,label:`Count variant`})]}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{style:{marginBottom:8,fontWeight:500},children:`compact`}),(0,u.jsx)(c,{page:3,totalPages:10,variant:`compact`,label:`Compact variant`})]}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{style:{marginBottom:8,fontWeight:500},children:`dots`}),(0,u.jsx)(c,{page:3,totalPages:8,variant:`dots`,label:`Dots variant`})]}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{style:{marginBottom:8,fontWeight:500},children:`input`}),(0,u.jsx)(c,{page:3,totalItems:100,pageSize:10,variant:`input`,label:`Input variant`})]}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`p`,{style:{marginBottom:8,fontWeight:500},children:`none`}),(0,u.jsx)(c,{page:3,totalPages:10,variant:`none`,label:`None variant`})]})]})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  ...
  <PaginationDemo page={3} totalItems={200} pageSize={10} variant="input" valueUnit="row" onRowNavigate={row => console.log('navigate to row', row)} />
  ...
  <PaginationDemo page={3} totalItems={200} pageSize={20} variant="input" formatLabel={(state, input) => <>
...
}`,...A.parameters?.docs?.source}}},j=[`Default`,`RightToLeft`,`PagesVariant`,`CountVariant`,`CompactVariant`,`DotsVariant`,`NoneVariant`,`InputVariant`,`InputVariantRowMode`,`InputVariantNoFirstLast`,`InputVariantCustomLabel`,`WithPageSizeSelector`,`CursorBased`,`SmallSize`,`ManyPages`,`ManyPagesLargeSiblings`,`SinglePage`,`Disabled`,`AllVariants`]}))();export{A as AllVariants,g as CompactVariant,h as CountVariant,w as CursorBased,f as Default,k as Disabled,_ as DotsVariant,y as InputVariant,S as InputVariantCustomLabel,x as InputVariantNoFirstLast,b as InputVariantRowMode,E as ManyPages,D as ManyPagesLargeSiblings,v as NoneVariant,m as PagesVariant,p as RightToLeft,O as SinglePage,T as SmallSize,C as WithPageSizeSelector,j as __namedExportsOrder,d as default};