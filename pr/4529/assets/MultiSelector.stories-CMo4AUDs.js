import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{n as i,t as a}from"./MultiSelector-D53jwioG.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{o=t(n()),a(),s=r(),c={title:`Core/MultiSelector`,component:i,tags:[`autodocs`],parameters:{layout:`centered`},decorators:[e=>(0,s.jsx)(`div`,{style:{width:300},children:(0,s.jsx)(e,{})})],argTypes:{label:{control:`text`},isLabelHidden:{control:`boolean`},description:{control:`text`},placeholder:{control:`text`},size:{control:`radio`,options:[`sm`,`md`,`lg`]},triggerDisplay:{control:`radio`,options:[`count`,`labels`,`badges`]},isDisabled:{control:`boolean`},disabledMessage:{control:`text`},isOptional:{control:`boolean`},isRequired:{control:`boolean`},hasSelectAll:{control:`boolean`},hasSearch:{control:`boolean`}}},l={render:e=>{let[t,n]=(0,o.useState)([`Role`,`Created`]);return(0,s.jsx)(i,{...e,label:e.label??`Columns`,options:e.options??[`Name`,`Email`,`Role`,`Status`,`Created`],value:t,onChange:n})},args:{placeholder:`Select columns...`}},u={render:()=>{let[e,t]=(0,o.useState)([]);return(0,s.jsx)(i,{label:`Permissions`,options:[{type:`section`,title:`Read`,options:[{value:`read_posts`,label:`Read posts`},{value:`read_comments`,label:`Read comments`},{value:`read_users`,label:`Read users`}]},{type:`section`,title:`Write`,options:[{value:`write_posts`,label:`Write posts`},{value:`write_comments`,label:`Write comments`}]}],value:e,onChange:t,placeholder:`Select permissions...`})},decorators:[e=>(0,s.jsx)(e,{})]},d={render:()=>{let[e,t]=(0,o.useState)([]);return(0,s.jsx)(i,{label:`Permissions`,hasSearch:!0,options:[{type:`section`,title:`Read`,options:[{value:`read_posts`,label:`Read posts`},{value:`read_comments`,label:`Read comments`},{value:`read_users`,label:`Read users`}]},{type:`section`,title:`Write`,options:[{value:`write_posts`,label:`Write posts`},{value:`write_comments`,label:`Write comments`}]}],value:e,onChange:t,placeholder:`Select permissions...`})},decorators:[e=>(0,s.jsx)(e,{})]},f={render:()=>{let[e,t]=(0,o.useState)([]);return(0,s.jsx)(i,{label:`Columns`,options:[`Name`,`Email`,`Role`,`Status`,`Created`,`Updated`],value:e,onChange:t,hasSelectAll:!0,placeholder:`Select columns...`})},decorators:[e=>(0,s.jsx)(e,{})]},p={render:()=>{let[e,t]=(0,o.useState)([]);return(0,s.jsx)(i,{label:`Countries`,options:[`United States`,`United Kingdom`,`Canada`,`Australia`,`Germany`,`France`,`Japan`,`Brazil`,`India`,`Mexico`],value:e,onChange:t,hasSearch:!0,hasSelectAll:!0,placeholder:`Select countries...`})},decorators:[e=>(0,s.jsx)(e,{})]},m={render:()=>{let[e,t]=(0,o.useState)([`Name`,`Email`]),[n,r]=(0,o.useState)([`Name`,`Email`,`Role`]),[a,c]=(0,o.useState)([`Name`,`Email`,`Role`,`Status`,`Created`]);return(0,s.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16,width:300},children:[(0,s.jsx)(i,{label:`Count (default)`,options:[`Name`,`Email`,`Role`,`Status`,`Created`],value:e,onChange:t,triggerDisplay:`count`}),(0,s.jsx)(i,{label:`Labels`,options:[`Name`,`Email`,`Role`,`Status`,`Created`],value:n,onChange:r,triggerDisplay:`labels`}),(0,s.jsx)(i,{label:`Badges`,options:[`Name`,`Email`,`Role`,`Status`,`Created`],value:a,onChange:c,triggerDisplay:`badges`,maxBadges:3})]})},decorators:[e=>(0,s.jsx)(e,{})]},h={render:()=>{let[e,t]=(0,o.useState)([`admin`]);return(0,s.jsx)(i,{label:`Roles`,options:[{value:`admin`,label:`Admin`,disabled:!0},{value:`editor`,label:`Editor`},{value:`viewer`,label:`Viewer`},{value:`guest`,label:`Guest`}],value:e,onChange:t,hasSelectAll:!0,placeholder:`Select roles...`})},decorators:[e=>(0,s.jsx)(e,{})]},g={render:()=>{let[e,t]=(0,o.useState)([]);return(0,s.jsx)(i,{label:`Columns`,options:[`Name`,`Email`,`Role`,`Status`,`Created`],value:e,onChange:t,isDisabled:!0,disabledMessage:`Select a table before choosing columns`,placeholder:`Select columns...`})},decorators:[e=>(0,s.jsx)(e,{})]},_={render:()=>{let[e,t]=(0,o.useState)([]),[n,r]=(0,o.useState)([`Email`]),[a,c]=(0,o.useState)([`Name`,`Email`]);return(0,s.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16,width:300},children:[(0,s.jsx)(i,{label:`Error`,options:[`Name`,`Email`,`Role`],value:e,onChange:t,status:{type:`error`,message:`Please select at least one column`},placeholder:`Select...`}),(0,s.jsx)(i,{label:`Warning`,options:[`Name`,`Email`,`Role`],value:n,onChange:r,status:{type:`warning`,message:`Email column has issues`}}),(0,s.jsx)(i,{label:`Success`,options:[`Name`,`Email`,`Role`],value:a,onChange:c,status:{type:`success`}})]})},decorators:[e=>(0,s.jsx)(e,{})]},v={render:()=>{let[e,t]=(0,o.useState)([]),[n,r]=(0,o.useState)([]),[a,c]=(0,o.useState)([]);return(0,s.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16,width:300},children:[(0,s.jsx)(i,{label:`Small`,size:`sm`,options:[`Name`,`Email`,`Role`],value:e,onChange:t,placeholder:`Small (28px)`}),(0,s.jsx)(i,{label:`Medium`,size:`md`,options:[`Name`,`Email`,`Role`],value:n,onChange:r,placeholder:`Medium (32px)`}),(0,s.jsx)(i,{label:`Large`,size:`lg`,options:[`Name`,`Email`,`Role`],value:a,onChange:c,placeholder:`Large (36px)`})]})},decorators:[e=>(0,s.jsx)(e,{})]},y={render:()=>{let[e,t]=(0,o.useState)([`name`,`email`]),[n,r]=(0,o.useState)([]);return(0,s.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16,width:300},children:[(0,s.jsx)(i,{label:`Visible columns`,description:`Choose which columns to display in the table`,options:[{value:`name`,label:`Name`},{value:`email`,label:`Email`},{value:`role`,label:`Role`},{value:`status`,label:`Status`},{value:`created`,label:`Created at`}],value:e,onChange:t,hasSelectAll:!0,isRequired:!0,triggerDisplay:`labels`}),(0,s.jsx)(i,{label:`Status filter`,description:`Filter by status`,options:[`Active`,`Inactive`,`Pending`,`Archived`],value:n,onChange:r,isOptional:!0,triggerDisplay:`badges`,placeholder:`All statuses`})]})},decorators:[e=>(0,s.jsx)(e,{})]},b={render:()=>{let e=[{value:`name`,label:`Name`},{value:`email`,label:`Email`},{value:`role`,label:`Role`},{value:`status`,label:`Status`},{value:`created`,label:`Created`},{value:`updated`,label:`Updated`},{value:`actions`,label:`Actions`}],[t,n]=(0,o.useState)([`name`,`email`,`role`,`status`]);return(0,s.jsx)(i,{label:`Columns`,isLabelHidden:!0,options:e,value:t,onChange:n,hasSelectAll:!0,hasSearch:!0,triggerDisplay:`count`,placeholder:`Columns`})},decorators:[e=>(0,s.jsx)(e,{})]},x={render:e=>{let[t,n]=(0,o.useState)([`react`,`typescript`]);return(0,s.jsx)(i,{...e,options:[{value:`react`,label:`React`},{value:`typescript`,label:`TypeScript`},{value:`stylex`,label:`StyleX`},{value:`vitest`,label:`Vitest`}],value:t,onChange:n,hasClear:!0})},args:{label:`Technologies`,placeholder:`Select technologies...`}},S={render:()=>{let[e,t]=(0,o.useState)([]),[n,r]=(0,o.useState)([]);return(0,s.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:24,width:300},children:[(0,s.jsx)(i,{label:`Attached (default)`,options:[`Name`,`Email`,`Role`],value:e,onChange:t,status:{type:`error`,message:`Select at least one column`},placeholder:`Select...`}),(0,s.jsx)(i,{label:`Detached`,options:[`Name`,`Email`,`Role`],value:n,onChange:r,status:{type:`error`,message:`Select at least one column`},statusVariant:`detached`,placeholder:`Select...`})]})},decorators:[e=>(0,s.jsx)(e,{})]},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...
  decorators: [Story => <Story />]
}`,...S.parameters?.docs?.source}}},C=[`Default`,`Sections`,`SearchableSections`,`SelectAll`,`Searchable`,`TriggerModes`,`DisabledItems`,`DisabledWithMessage`,`Status`,`Sizes`,`FormComposition`,`ColumnVisibility`,`Clearable`,`StatusVariantComparison`]}))();export{x as Clearable,b as ColumnVisibility,l as Default,h as DisabledItems,g as DisabledWithMessage,y as FormComposition,p as Searchable,d as SearchableSections,u as Sections,f as SelectAll,v as Sizes,_ as Status,S as StatusVariantComparison,m as TriggerModes,C as __namedExportsOrder,c as default};