import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Text-kN0lxIEM.js";import{t as a}from"./Heading-CRBm-1Kj.js";import{c as o}from"./Stack-DGkPE1yj.js";import{t as s}from"./Text-CJp0wfC_.js";import{u as c}from"./iframe-CTo8IH4i.js";import{At as l,Et as u,J as d,Mt as f,Ot as p,Pt as m,Q as h,X as g,at as _,ct as v,et as y,t as b,vt as x}from"./src-WZEjeY-7.js";import{n as S,t as C}from"./useDataset-D0R9TzHE.js";var w,T,E,D,O,k,A,j,M,N,P,F;e((()=>{w=t(n()),b(),c(),s(),C(),T=r(),E={title:`Lab/Chart Interactions`,tags:[`autodocs`]},D=[{month:`Jan`,revenue:4200,expenses:2800},{month:`Feb`,revenue:3800,expenses:2600},{month:`Mar`,revenue:5100,expenses:3200},{month:`Apr`,revenue:4600,expenses:2900},{month:`May`,revenue:5400,expenses:3100},{month:`Jun`,revenue:6200,expenses:3400},{month:`Jul`,revenue:5800,expenses:3300},{month:`Aug`,revenue:5500,expenses:3e3},{month:`Sep`,revenue:4900,expenses:2700},{month:`Oct`,revenue:5200,expenses:3100},{month:`Nov`,revenue:5700,expenses:3200},{month:`Dec`,revenue:6800,expenses:3600}],O={render:()=>{let e=_(),[t,n]=(0,w.useState)(null);return(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`1D Brush — Bar Chart`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Drag to select a range. `,t??`Click to clear.`]}),(0,T.jsxs)(m,{data:D,xKey:`month`,yKeys:[`revenue`],height:300,children:[(0,T.jsx)(l,{horizontal:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(p,{dataKey:`revenue`,color:e.categorical(1)[0]}),(0,T.jsx)(y,{onBrush:(e,t)=>n(`${t.length} months selected`),onClear:()=>n(null)})]})]})}},k={render:()=>{let e=_(),[t,n]=(0,w.useState)(null);return(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`1D Brush — Line Chart`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Drag to select a range. `,t??`Click to clear.`]}),(0,T.jsxs)(m,{data:D,xKey:`month`,yKeys:[`revenue`,`expenses`],height:300,children:[(0,T.jsx)(l,{horizontal:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(u,{dataKey:`revenue`,color:e.categorical(2)[0],dots:!0}),(0,T.jsx)(u,{dataKey:`expenses`,color:e.categorical(2)[1],dots:!0}),(0,T.jsx)(y,{onBrush:(e,t)=>n(`${t.length} months selected`),onClear:()=>n(null)})]})]})}},A={render:()=>{let e=_(),[t]=S(`cars.json`),[n,r]=(0,w.useState)(null),s=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]);return s.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`2D Brush — Scatter Plot`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Drag a rectangle to select.`,` `,n==null?`Click to clear.`:`${n} points selected.`]}),(0,T.jsxs)(m,{data:s,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:350,children:[(0,T.jsx)(l,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(x,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(y,{mode:`xy`,onBrush:(e,t)=>r(t.length),onClear:()=>r(null)})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},j={render:()=>{let e=_(),[t]=S(`cars.json`),n=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]);return n.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Crosshair`}),(0,T.jsxs)(m,{data:n,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:350,children:[(0,T.jsx)(l,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(x,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(v,{crosshair:`xy`,crosshairLabels:!0,xFormat:e=>`${Math.round(Number(e))} hp`,yFormat:e=>`${Math.round(e)} mpg`})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},M={render:()=>{let e=_(),[t]=S(`cars.json`),n=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]),[r,s]=(0,w.useState)([40,230]),[c,u]=(0,w.useState)([8,47]);return n.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Zoom & Pan`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Scroll to zoom, drag to pan. x: [`,Math.round(r[0]),`,`,` `,Math.round(r[1]),`]`]}),(0,T.jsxs)(m,{data:n,xKey:`hp`,yKeys:[`mpg`],xDomain:r,yDomain:c,height:350,children:[(0,T.jsx)(l,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(x,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(h,{onXDomainChange:s,onYDomainChange:u})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},N={render:()=>{let e=_(),[t]=S(`cars.json`),n=(0,w.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null).map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[t]),[r,s]=(0,w.useState)([]);return n.length?(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Click to Select`}),(0,T.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`Click a point. Shift-click for multi. `,r.length,` selected.`]}),(0,T.jsxs)(m,{data:n,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:350,children:[(0,T.jsx)(l,{horizontal:!0,vertical:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(x,{dataKey:`mpg`,color:e.categorical(1)[0],radius:3}),(0,T.jsx)(g,{selected:r,onSelectionChange:s})]})]}):(0,T.jsx)(i,{type:`supporting`,children:`Loading…`})}},P={render:()=>{let e=_();return(0,T.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,T.jsx)(a,{level:3,children:`Reference Lines`}),(0,T.jsxs)(m,{data:D,xKey:`month`,yKeys:[`revenue`],height:300,children:[(0,T.jsx)(l,{horizontal:!0}),(0,T.jsx)(f,{position:`bottom`}),(0,T.jsx)(f,{position:`left`}),(0,T.jsx)(p,{dataKey:`revenue`,color:e.categorical(1)[0]}),(0,T.jsx)(d,{y:5e3,label:`Target`,color:e.semantic.positive}),(0,T.jsx)(d,{y:4700,label:`Average`,color:e.semantic.neutral})]})]})}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  render: () => {
