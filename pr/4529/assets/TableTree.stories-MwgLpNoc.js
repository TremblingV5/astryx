...
}`,...w.parameters?.docs?.source},description:{story:"The `indent` token controls the step per level: `sm` (spacing-3), `md`\n(spacing-4, the default), and `lg` (spacing-6).",...w.parameters?.docs?.description}}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...T.parameters?.docs?.source},description:{story:"Composed with selection. The canonical plugin order puts `tree` before\n`selection`, so the checkbox column lands to the left of the indented\ntree column, and selection operates on the visible (flattened) rows.",...T.parameters?.docs?.description}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  render: () => {
    const {
      sortConfig,
      applySort
...
}`,...E.parameters?.docs?.source},description:{story:"Composed with sorting. `applySort` is passed as `sortSiblings`, so each\nsibling group sorts independently — children always stay directly under\ntheir parent and levels never interleave. Sort by Group or Headcount.",...E.parameters?.docs?.description}}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...D.parameters?.docs?.source},description:{story:"Lazy loading. `isItemExpandable` shows an expander before the children\nexist; `onExpandedIdsChange` triggers the fetch, and the rows appear when\nthe data arrives.",...D.parameters?.docs?.description}}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  render: () => {
    const flat: OrgRow[] = [{
      id: 'a',
      name: 'Engineering',
...
}`,...O.parameters?.docs?.source},description:{story:`Migration case: the same plugin on flat data (no \`children\` anywhere) is a
no-op — no expanders, no indent spacers, no tree ARIA. Adopting the plugin
before the data becomes hierarchical changes nothing.`,...O.parameters?.docs?.description}}},k=[`Default`,`ExpandAndCollapseAll`,`HeaderExpandAllControl`,`IndentSizes`,`WithSelection`,`WithSiblingSorting`,`LazyLoadedChildren`,`FlatDataIsANoOp`]}))();export{x as Default,S as ExpandAndCollapseAll,O as FlatDataIsANoOp,C as HeaderExpandAllControl,w as IndentSizes,D as LazyLoadedChildren,T as WithSelection,E as WithSiblingSorting,k as __namedExportsOrder,b as default};