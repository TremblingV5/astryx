import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{o as r}from"./useTheme-BOwam6Vh.js";import{t as i}from"./jsx-runtime-cM__dR4X.js";import{t as a,x as o}from"./theme-Cv2oSby0.js";import{n as s,t as c}from"./DateTimeInput-CtNagu-d.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;t((()=>{l=e(n()),c(),a(),u=i(),d={title:`Core/DateTimeInput`,component:s,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Label text (required)`},isLabelHidden:{control:`boolean`,description:`Visually hide the label (still accessible to screen readers)`},placeholder:{control:`text`,description:`Placeholder text`},description:{control:`text`,description:`Description text displayed between the label and input`},isOptional:{control:`boolean`,description:`Whether the field is optional (mutually exclusive with isRequired)`},isRequired:{control:`boolean`,description:`Whether the field is required (mutually exclusive with isOptional)`},isDisabled:{control:`boolean`,description:`Whether the input is disabled`},disabledMessage:{control:`text`,description:`Explains why the input is disabled. With isDisabled, shows a tooltip on hover/keyboard focus and keeps the field focusable via aria-disabled (activation stays blocked). Use this instead of wrapping a disabled DateTimeInput in Tooltip.`},size:{control:`radio`,options:[`sm`,`md`,`lg`]},hourFormat:{control:`radio`,options:[`12h`,`24h`],description:`Hour format for display`},hasSeconds:{control:`boolean`,description:`Whether to include seconds in the time`},hasClear:{control:`boolean`,description:`Whether to show a clear button`},numberOfMonths:{control:`radio`,options:[1,2],description:`Number of months to display in calendar`},timeIncrement:{control:`number`,description:`Minutes to increment/decrement with arrow keys`}}},f={render:e=>{let[t,n]=(0,l.useState)(void 0);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Meeting time`,placeholder:`Select a date`}},p={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T14:30`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Event time`}},m={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T14:30`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Appointment`,hourFormat:`24h`}},h={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T14:30:45`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Log timestamp`,hasSeconds:!0}},g={render:e=>{let[t,n]=(0,l.useState)(void 0);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Deadline`,description:`When is this task due?`,placeholder:`Select deadline`}},_={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T09:00`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Start time`,hasClear:!0}},v={render:e=>{let[t,n]=(0,l.useState)(void 0);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Appointment`,min:`2026-03-15T09:00`,max:`2026-03-15T17:00`,description:`Available: Mar 15, 9 AM - 5 PM`}},y={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T09:00`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Time slot`,timeIncrement:15,description:`Use arrow keys to change by 15 minutes`}},b={render:e=>{let[t,n]=(0,l.useState)(void 0);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Preferred time`,isOptional:!0,placeholder:`Select a date (optional)`}},x={render:e=>{let[t,n]=(0,l.useState)(void 0);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Start time`,isRequired:!0}},S={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T10:00`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Locked time`,isDisabled:!0}},C={render:e=>{let[t,n]=(0,l.useState)(void 0);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Meeting time`,isDisabled:!0,disabledMessage:`You need the Editor role to change this`}},w={render:()=>{let[e,t]=(0,l.useState)(void 0),[n,r]=(0,l.useState)(void 0),[i,a]=(0,l.useState)(void 0);return(0,u.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,maxWidth:`460px`},children:[(0,u.jsx)(s,{label:`Small (28px)`,value:e,onChange:t,placeholder:`Small size`,size:`sm`}),(0,u.jsx)(s,{label:`Medium (32px)`,value:n,onChange:r,placeholder:`Medium size (default)`,size:`md`}),(0,u.jsx)(s,{label:`Large (36px)`,value:i,onChange:a,placeholder:`Large size`,size:`lg`})]})}},T={render:e=>{let[t,n]=(0,l.useState)(void 0);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Travel departure`,numberOfMonths:2}},E={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T14:30`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Event time`,status:{type:`error`,message:`This time slot is not available`}}},D={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T07:00`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Meeting time`,status:{type:`warning`,message:`Early morning meeting - are you sure?`}}},O={render:e=>{let[t,n]=(0,l.useState)(`2026-03-15T10:00`);return(0,u.jsx)(s,{...e,value:t,onChange:n})},args:{label:`Scheduled time`,status:{type:`success`,message:`Time slot is available`}}},k={render:()=>{let[e,t]=(0,l.useState)(void 0),[n,r]=(0,l.useState)(`2026-03-15T14:30`),[i,a]=(0,l.useState)(`2026-03-15T14:30`),[o,c]=(0,l.useState)(void 0),[d,f]=(0,l.useState)(`2026-03-15T10:00`),[p,m]=(0,l.useState)(`2026-03-15T22:00`);return(0,u.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,maxWidth:`460px`},children:[(0,u.jsx)(s,{label:`Default`,value:e,onChange:t,placeholder:`Select a date`}),(0,u.jsx)(s,{label:`With value (12h)`,value:n,onChange:r}),(0,u.jsx)(s,{label:`24-hour format`,value:i,onChange:a,hourFormat:`24h`}),(0,u.jsx)(s,{label:`With description`,description:`Pick your preferred datetime`,value:o,onChange:c}),(0,u.jsx)(s,{label:`Disabled`,isDisabled:!0,value:d,onChange:f}),(0,u.jsx)(s,{label:`With error`,value:p,onChange:m,status:{type:`error`,message:`Invalid datetime selection`}})]})}},A=r({name:`date-time-input-segments-demo`,components:{"date-time-input-date-segment":{base:{borderColor:`var(--color-accent)`}},"date-time-input-time-segment":{base:{backgroundColor:`var(--color-background-muted)`}}}}),j={render:()=>{let[e,t]=(0,l.useState)();return(0,u.jsx)(o,{theme:A,mode:`light`,children:(0,u.jsx)(s,{label:`Themed segments`,description:`Date segment gets an accent border; time segment a muted fill.`,value:e,onChange:t})})}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: args => {
