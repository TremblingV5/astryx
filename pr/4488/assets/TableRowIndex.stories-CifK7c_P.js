import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./Text-BrbTLH6i.js";import{t as i}from"./jsx-runtime-cM__dR4X.js";import{I as a,R as o,_ as s,j as c,t as l}from"./Table-CimToFSw.js";import{i as u}from"./Stack-BdU1sgSP.js";import{t as d}from"./Layout-DX6d16sp.js";import{t as f}from"./Text-gNERuNVk.js";import{_ as p,g as m,t as h}from"./Table-BwawNP13.js";var g,_,v,y,b,x,S,C,w,T,E,D,O;t((()=>{g=e(n()),l(),f(),d(),_=i(),v=[{id:`t1`,title:`Nightfall`,artist:`Ava Chen`,plays:1820},{id:`t2`,title:`Ember`,artist:`Liam Park`,plays:942},{id:`t3`,title:`Tidal`,artist:`Zoe Vega`,plays:3310},{id:`t4`,title:`Cinder`,artist:`Max Ross`,plays:604},{id:`t5`,title:`Halcyon`,artist:`Mia Cole`,plays:2075}],y=[{key:`title`,header:`Title`,width:p(2)},{key:`artist`,header:`Artist`,width:p(2)},{key:`plays`,header:`Plays`,width:m(90),align:`end`,sortable:!0}],b={title:`Core/TableRowIndex`,tags:[`autodocs`]},x={render:()=>{let e=s({data:v});return(0,_.jsx)(h,{data:v,columns:y,idKey:`id`,hasHover:!0,plugins:{rowIndex:e}})}},S={render:()=>{let e=s({data:v,label:`No.`,startFrom:0});return(0,_.jsx)(h,{data:v,columns:y,idKey:`id`,hasHover:!0,plugins:{rowIndex:e}})}},C={render:()=>{let[e,t]=(0,g.useState)([{sortKey:`plays`,direction:`descending`}]),{sortedData:n,sortConfig:r}=a({data:v,sort:e,onSortChange:t}),i=o(r),c=s({data:n,getRowKey:e=>e.id}),l=(0,g.useMemo)(()=>({rowIndex:c,sort:i}),[c,i]);return(0,_.jsx)(h,{data:n,columns:y,idKey:`id`,hasHover:!0,plugins:l})}},w=Array.from({length:42},(e,t)=>({id:`c${t+1}`,name:`Contact ${t+1}`,city:[`Lisbon`,`Tokyo`,`Oslo`,`Cairo`][t%4]})),T=[{key:`name`,header:`Name`,width:p(2)},{key:`city`,header:`City`,width:p(1)}],E={render:()=>(0,_.jsxs)(u,{gap:2,children:[(0,_.jsx)(r,{type:`body`,children:`No visible index column, but each row still exposes aria-rowindex, and the table exposes aria-rowcount. Inspect the DOM to verify.`}),(0,_.jsx)(h,{data:w.slice(0,5),columns:T,idKey:`id`,rowCount:w.length})]})},D={render:()=>{let[e,t]=(0,g.useState)(3),n=(e-1)*10,r=w.slice(n,n+10),i=c({page:e,onPageChange:t,totalItems:w.length,pageSize:10}),a=s({data:r,getRowKey:e=>e.id,startFrom:n+1}),o=(0,g.useMemo)(()=>({rowIndex:a,pagination:i}),[a,i]);return(0,_.jsx)(h,{data:r,columns:T,idKey:`id`,hasHover:!0,rowIndexStart:n+1,rowCount:w.length,plugins:o})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: () => {
