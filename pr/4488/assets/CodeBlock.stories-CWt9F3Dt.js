import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{i as t,t as n}from"./CodeBlock-DKyfU6JG.js";var r,i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{n(),r={title:`Core/CodeBlock`,component:t,tags:[`autodocs`],argTypes:{language:{control:`select`,options:[`typescript`,`javascript`,`json`,`html`,`css`,`python`,`bash`,`php`,`hack`,`yaml`,`markdown`,`plaintext`],description:`Language for syntax highlighting`},size:{control:`select`,options:[`sm`,`md`],description:`Text size`},width:{control:`text`,description:`Width of the code block (any CSS width value)`},container:{control:`select`,options:[`card`,`section`],description:`Container presentation style`},hasLineNumbers:{control:`boolean`},hasCopyButton:{control:`boolean`},isWrapped:{control:`boolean`},isCollapsible:{control:`boolean`},collapsibleThreshold:{control:`number`}}},i=`import {useState, useEffect} from 'react';
...
It preserves whitespace and line breaks.
  ...
  Indentation is maintained.
    Nested indentation too.`,language:`plaintext`,title:`notes.txt`,hasLineNumbers:!0}},v={args:{code:i,language:`typescript`,title:`useUser.ts`,width:`100%`}},y={args:{code:i,language:`typescript`,title:`useUser.ts`,width:`100%`,container:`section`}},b={args:{code:i,language:`typescript`,title:`useUser.ts`,hasLineNumbers:!0,isCollapsible:!0}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    code: tsExample,
    language: 'typescript',
    title: 'useUser.ts',
...
}`,...b.parameters?.docs?.source}}},x=[`Default`,`WithHighlightedLines`,`JSON`,`Python`,`HTML`,`CSS`,`Bash`,`SingleLine`,`Wrapped`,`WithMaxHeight`,`SmallSize`,`NoHeader`,`Plaintext`,`FullWidth`,`ContainerSection`,`Collapsible`]}))();export{d as Bash,u as CSS,b as Collapsible,y as ContainerSection,a as Default,v as FullWidth,l as HTML,s as JSON,g as NoHeader,_ as Plaintext,c as Python,f as SingleLine,h as SmallSize,o as WithHighlightedLines,m as WithMaxHeight,p as Wrapped,x as __namedExportsOrder,r as default};