import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{B as i,H as a,j as o,k as s,t as c}from"./Table-CimToFSw.js";import{t as l}from"./Table-BwawNP13.js";function u({variant:e=`pages`,position:t=`below`,align:n=`start`}){let[r,i]=(0,d.useState)(1),a=o({page:r,onPageChange:i,totalItems:p.length,pageSize:10,variant:e,position:t,align:n});return(0,f.jsx)(l,{data:s(p,r,10),columns:m,idKey:`id`,plugins:{pagination:a}})}var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;t((()=>{d=e(n()),c(),f=r(),p=Array.from({length:50},(e,t)=>({id:String(t+1),name:`User ${t+1}`,email:`user${t+1}@example.com`,role:[`Engineer`,`Designer`,`Manager`,`Admin`,`Analyst`][t%5]})),m=[{key:`name`,header:`Name`},{key:`email`,header:`Email`},{key:`role`,header:`Role`}],h={title:`Core/TablePagination`,tags:[`autodocs`]},g={render:()=>{let[e,t]=(0,d.useState)(1),n=o({page:e,onPageChange:t,totalItems:p.length,pageSize:10});return(0,f.jsx)(`div`,{style:{maxWidth:600},children:(0,f.jsx)(l,{data:s(p,e,10),columns:m,idKey:`id`,plugins:{pagination:n}})})}},_={render:()=>{let[e,t]=(0,d.useState)(1),n=p.slice((e-1)*10,e*10),r=o({page:e,onPageChange:t,totalItems:p.length,pageSize:10});return(0,f.jsxs)(`div`,{style:{maxWidth:600},children:[(0,f.jsx)(`p`,{style:{marginBottom:8,fontSize:14,color:`#666`},children:`Server-side: data is pre-sliced, no paginatedData() needed.`}),(0,f.jsx)(l,{data:n,columns:m,idKey:`id`,plugins:{pagination:r}})]})}},v={render:()=>{let[e,t]=(0,d.useState)(1),[n,r]=(0,d.useState)(10),i=o({page:e,onPageChange:t,totalItems:p.length,pageSize:n,onPageSizeChange:r,pageSizeOptions:[5,10,25,50]});return(0,f.jsx)(`div`,{style:{maxWidth:600},children:(0,f.jsx)(l,{data:s(p,e,n),columns:m,idKey:`id`,plugins:{pagination:i}})})}},y={render:()=>{let[e,t]=(0,d.useState)(1),n=e*10<p.length,r=o({page:e,onPageChange:t,hasMore:n,pageSize:10});return(0,f.jsxs)(`div`,{style:{maxWidth:600},children:[(0,f.jsxs)(`p`,{style:{marginBottom:8,fontSize:14,color:`#666`},children:[`Cursor-based: total unknown, only hasMore=`,String(n),`.`]}),(0,f.jsx)(l,{data:s(p,e,10),columns:m,idKey:`id`,plugins:{pagination:r}})]})}},b={render:()=>{let[e,t]=(0,d.useState)(1),n=o({page:e,onPageChange:t,totalItems:p.length,pageSize:10,position:`above`});return(0,f.jsx)(`div`,{style:{maxWidth:600},children:(0,f.jsx)(l,{data:s(p,e,10),columns:m,idKey:`id`,plugins:{pagination:n}})})}},x={render:()=>{let[e,t]=(0,d.useState)(1),n=o({page:e,onPageChange:t,totalItems:p.length,pageSize:10,position:`both`});return(0,f.jsx)(`div`,{style:{maxWidth:600},children:(0,f.jsx)(l,{data:s(p,e,10),columns:m,idKey:`id`,plugins:{pagination:n}})})}},S={render:()=>{let[e,t]=(0,d.useState)(1),[n,r]=(0,d.useState)(new Set),c=o({page:e,onPageChange:t,totalItems:p.length,pageSize:10}),u=s(p,e,10),{selectionConfig:h}=i({data:u,idKey:`id`,selectedKeys:n,setSelectedKeys:r}),g=a(h);return(0,f.jsxs)(`div`,{style:{maxWidth:600},children:[(0,f.jsxs)(`p`,{style:{marginBottom:8,fontSize:14,color:`#666`},children:[`Pagination + Selection composed. Selected: `,n.size]}),(0,f.jsx)(l,{data:u,columns:m,idKey:`id`,plugins:{selection:g,pagination:c}})]})}},C={argTypes:{variant:{control:`select`,options:[`pages`,`count`,`compact`,`dots`,`none`],description:`What appears between prev/next buttons`},position:{control:`select`,options:[`below`,`above`,`both`,`none`],description:`Where pagination renders relative to the table`},align:{control:`select`,options:[`start`,`center`,`end`],description:`Horizontal alignment of the pagination controls`}},args:{variant:`pages`,position:`below`,align:`center`},render:e=>(0,f.jsx)(`div`,{style:{maxWidth:700},children:(0,f.jsx)(u,{variant:e.variant,position:e.position,align:e.align})})},w=[`pages`,`count`,`compact`,`dots`],T=[`below`,`above`,`both`],E=[`start`,`center`,`end`],D={render:()=>(0,f.jsx)(`div`,{style:{fontFamily:`sans-serif`,maxWidth:700},children:w.flatMap(e=>T.flatMap(t=>E.map(n=>(0,f.jsxs)(`div`,{style:{marginBottom:48,paddingBottom:48,borderBottom:`1px solid #e5e5e5`},children:[(0,f.jsx)(`div`,{style:{display:`inline-flex`,gap:8,marginBottom:12,flexWrap:`wrap`},children:[{label:`variant`,value:e},{label:`position`,value:t},{label:`align`,value:n}].map(({label:e,value:t})=>(0,f.jsxs)(`span`,{style:{fontSize:11,fontFamily:`monospace`,background:`#f0f0f0`,borderRadius:4,padding:`2px 6px`,color:`#555`},children:[e,`="`,t,`"`]},e))}),(0,f.jsx)(u,{variant:e,position:t,align:n})]},`${e}-${t}-${n}`))))})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: () => {
