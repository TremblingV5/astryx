import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{l as r,n as i,t as a,u as o}from"./themeProps-DlHa58hS.js";import{t as s,x as c}from"./utils-jTHzKw3y.js";import{r as l}from"./devWarning-CdkEyq26.js";import{t as u}from"./jsx-runtime-cM__dR4X.js";import{n as d,t as f}from"./layerAnimations.stylex-Da83fcE8.js";import{n as p,t as m}from"./useIsomorphicLayoutEffect-BLjA_OV8.js";import{n as h,t as g}from"./usePopover-rgx39Pre.js";import{n as _,t as v}from"./InteractiveRoleContext-CN1V-yod.js";function y(e){return e.matches(C)?e:e.querySelector(C)}function b({children:e,anchorRef:t,content:n,placement:r=`below`,alignment:a=`start`,isOpen:s,onOpenChange:l,isEnabled:u=!0,width:f,label:m,hasCloseButton:g,closeButtonLabel:_,hasAutoFocus:b,hasLightDismiss:C=!0,hasEscapeDismiss:T=!0,xstyle:E,className:D,style:O,"data-testid":k}){let A=(0,x.useRef)(null),j=s!==void 0,M=(0,x.useRef)(0),N=h({dialogLabel:m,hasLightDismiss:C,hasEscapeDismiss:T,hasCloseButton:g,closeButtonLabel:_,hasAutoFocus:b,onShow:(0,x.useCallback)(()=>{l?.(!0)},[l]),onHide:(0,x.useCallback)(()=>{M.current=Date.now(),l?.(!1)},[l])}),P=(0,x.useCallback)(()=>{u&&(Date.now()-M.current<50||N.toggle())},[u,N]),F=(0,x.useCallback)(e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),P())},[P]),I=(0,x.useCallback)(e=>{e.setAttribute(`aria-haspopup`,N.triggerProps[`aria-haspopup`]),e.setAttribute(`aria-expanded`,String(N.triggerProps[`aria-expanded`])),e.setAttribute(`aria-controls`,N.triggerProps[`aria-controls`]),e.addEventListener(`click`,P);let t=e.tagName!==`BUTTON`&&e.getAttribute(`role`)===`button`;return t&&e.addEventListener(`keydown`,F),()=>{e.removeAttribute(`aria-haspopup`),e.removeAttribute(`aria-expanded`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,P),t&&e.removeEventListener(`keydown`,F)}},[N,P,F]);p(()=>{if(!t)return;let e=t.current;if(!e)return;let n=y(e);if(!n)return;N.triggerRef(e);let r=I(n);return()=>{N.triggerRef(null),r()}},[t,N,I]),p(()=>{if(t||typeof e==`function`)return;let n=A.current;if(!n)return;N.triggerRef(n);let r=y(n);if(!r)return;let i=I(r);return()=>{N.triggerRef(null),i()}},[t,N,I]),p(()=>{j&&(s&&!N.isOpen?N.show():!s&&N.isOpen&&N.hide())},[s,j,N]);let L=f?w.customWidth(f):w.matchTrigger;return t&&e==null?(0,S.jsx)(S.Fragment,{children:N.render((0,S.jsx)(`div`,{"data-testid":k,...c(i(`popover`),o(w.contentPadding,E),D,O),children:n}),{placement:r,alignment:a,xstyle:[L,w.gap,d[r]]})}):typeof e==`function`?(0,S.jsxs)(S.Fragment,{children:[e({ref:N.triggerRef,onClick:P,"aria-haspopup":`dialog`,"aria-expanded":N.isOpen,"aria-controls":N.id}),N.render((0,S.jsx)(`div`,{"data-testid":k,...c(i(`popover`),o(w.contentPadding,E),D,O),children:n}),{placement:r,alignment:a,xstyle:[L,w.gap,d[r]]})]}):(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(v,{value:`button`,children:(0,S.jsx)(`div`,{ref:A,className:`astryx3nfvp2`,children:e})}),N.render((0,S.jsx)(`div`,{"data-testid":k,...c(i(`popover`),o(w.contentPadding,E),D,O),children:n}),{placement:r,alignment:a,xstyle:[L,w.gap,d[r]]})]})}var x,S,C,w,T=t((()=>{x=e(n(),1),m(),r(),s(),l(),g(),f(),_(),a(),S=u(),C=`button, [role="button"]`,w={contentPadding:{kLKAdn:`astryx1vlblms`,kGO01o:`astryxvmdzux`,kZCmMZ:`astryx126nfab`,kwRFfy:`astryx1t818jl`,$$css:!0},gap:{keoZOQ:`astryxcsaf9d`,k1K539:`astryx14cgwvg`,$$css:!0},customWidth:e=>[{kzqmXN:(typeof e==`number`?`${e}px`:e)==null?typeof e==`number`?`${e}px`:e:`astryx5lhr3w`,$$css:!0},{"--x-width":(e=>typeof e==`number`?e+`px`:e??void 0)(typeof e==`number`?`${e}px`:e)}],matchTrigger:{k7Eaqz:`astryxrzjruh`,$$css:!0}},b.displayName=`Popover`,b.__docgenInfo={description:`A click-triggered popover for displaying interactive content anchored to a trigger.
...
@default true`,defaultValue:{value:`true`,computed:!1}},"data-testid":{required:!1,tsType:{name:`string`},description:`Test ID for the popover container.`}},composes:[`Pick`]}})),E=t((()=>{g(),T()}));export{b as n,T as r,E as t};