import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{c as t,s as n}from"./themeProps-DlHa58hS.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{n as i,r as a}from"./SizeContext-9C5DZxUg.js";import{r as o,t as s}from"./i18n-C7bRBLfk.js";import{n as c,t as l}from"./globalIconRegistry-DdNEt-Zf.js";import{n as u,t as d}from"./DropdownMenu-CA5LIGDv.js";function f({items:e,label:n,variant:r=`ghost`,size:i,icon:s,isDisabled:c=!1,isMenuOpen:u,onOpenChange:f,xstyle:m,className:h,style:g,"data-testid":_,ref:v}){let y=o(),b=n??y(`@astryx.moreMenu.label`),x=a(i,`md`),S=l(`moreHorizontal`);return(0,p.jsx)(d,{className:h?`${t(`more-menu`)} ${h}`:t(`more-menu`),xstyle:m,style:g,isMenuOpen:u,onOpenChange:f,button:{label:b,icon:s??S,variant:r,size:x,isDisabled:c,tooltip:b,isIconOnly:!0,ref:v},items:e,hasChevron:!1,"data-testid":_})}var p,m=e((()=>{c(),u(),i(),n(),s(),p=r(),f.displayName=`MoreMenu`,f.__docgenInfo={description:`Overflow menu with a three-dot icon trigger.
