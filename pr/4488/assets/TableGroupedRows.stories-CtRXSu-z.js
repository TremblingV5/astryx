import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{t as i,y as a}from"./Table-CimToFSw.js";import{_ as o,g as s,t as c}from"./Table-BwawNP13.js";function l(e=[]){let[t,n]=(0,u.useState)(new Set(e));return{collapsedGroups:t,onToggleGroup:(0,u.useCallback)(e=>{n(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},[])}}var u,d,f,p,m,h,g,_,v;t((()=>{u=e(n()),i(),d=r(),f=[{id:`1`,name:`Ava Chen`,team:`Design Systems`,role:`Staff Eng`},{id:`2`,name:`Liam Park`,team:`Design Systems`,role:`Engineer`},{id:`3`,name:`Zoe Vega`,team:`Design Systems`,role:`Manager`},{id:`4`,name:`Max Ross`,team:`Infra`,role:`Senior Eng`},{id:`5`,name:`Mia Cole`,team:`Infra`,role:`Engineer`},{id:`6`,name:`Leo Nash`,team:`Growth`,role:`PM`}],p=[{key:`name`,header:`Name`,width:o(2)},{key:`role`,header:`Role`,width:s(140)}],m={title:`Core/TableGroupedRows`,tags:[`autodocs`]},h={render:()=>{let{collapsedGroups:e,onToggleGroup:t}=l(),n=a({data:f,groupBy:e=>e.team,collapsedGroups:e,onToggleGroup:t,getRowKey:e=>e.id});return(0,d.jsx)(c,{data:n.data,columns:p,idKey:n.idKey,hasHover:!0,plugins:{grouped:n.plugin}})}},g={render:()=>{let{collapsedGroups:e,onToggleGroup:t}=l([`Infra`]),n=a({data:f,groupBy:e=>e.team,collapsedGroups:e,onToggleGroup:t,getRowKey:e=>e.id});return(0,d.jsx)(c,{data:n.data,columns:p,idKey:n.idKey,hasHover:!0,plugins:{grouped:n.plugin}})}},_={render:()=>{let{collapsedGroups:e,onToggleGroup:t}=l(),n=a({data:f,groupBy:e=>e.team,collapsedGroups:e,onToggleGroup:t,getRowKey:e=>e.id,groupOrder:[`Growth`,`Infra`],renderGroupHeader:(e,t,n)=>(0,d.jsxs)(`span`,{children:[(0,d.jsx)(`strong`,{children:e}),` — `,t,` `,t===1?`person`:`people`,n?` (hidden)`:``]})});return(0,d.jsx)(c,{data:n.data,columns:p,idKey:n.idKey,hasHover:!0,plugins:{grouped:n.plugin}})}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => {
    const {
      collapsedGroups,
      onToggleGroup
