import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{C as i,t as a,x as o}from"./Table-CimToFSw.js";import{g as s,t as c}from"./Table-BwawNP13.js";var l,u,d,f,p,m,h,g,_,v,y,b;t((()=>{l=e(n()),a(),u=r(),d=[{id:`1`,name:`Alice Nguyen`,email:`alice@example.com`,team:`Design Systems`,role:`Staff Engineer`,location:`San Francisco`,startDate:`2019-03-12`,manager:`Priya Patel`,status:`Active`},{id:`2`,name:`Bob Martinez`,email:`bob@example.com`,team:`Design Systems`,role:`Senior Designer`,location:`New York`,startDate:`2020-07-01`,manager:`Priya Patel`,status:`Active`},{id:`3`,name:`Charlie Okafor`,email:`charlie@example.com`,team:`Platform`,role:`Engineering Manager`,location:`London`,startDate:`2017-11-20`,manager:`Sam Lee`,status:`On leave`},{id:`4`,name:`Diana Rossi`,email:`diana@example.com`,team:`Platform`,role:`Staff Engineer`,location:`Remote`,startDate:`2021-01-15`,manager:`Sam Lee`,status:`Active`},{id:`5`,name:`Ehsan Karimi`,email:`ehsan@example.com`,team:`Growth`,role:`Product Engineer`,location:`Berlin`,startDate:`2022-05-30`,manager:`Mei Chen`,status:`Active`}],f=[{key:`name`,header:`Name`,width:s(180)},{key:`email`,header:`Email`,width:s(220)},{key:`team`,header:`Team`,width:s(180)},{key:`role`,header:`Role`,width:s(200)},{key:`location`,header:`Location`,width:s(160)},{key:`startDate`,header:`Start date`,width:s(140)},{key:`manager`,header:`Manager`,width:s(180)},{key:`status`,header:`Status`,width:s(140)}],p={title:`Core/TableStickyColumns`,tags:[`autodocs`]},m={marginBottom:8,fontSize:14,color:`#666`},h={render:()=>{let e=o({startKeys:[`name`]});return(0,u.jsxs)(`div`,{style:{maxWidth:720},children:[(0,u.jsxs)(`p`,{style:m,children:[(0,u.jsx)(`code`,{children:`startKeys: ['name']`}),` — scroll right to see the Name column stay pinned with a drop shadow.`]}),(0,u.jsx)(c,{data:d,columns:f,idKey:`id`,plugins:{stickyColumns:e}})]})}},g={render:()=>{let e=o({endKeys:[`status`]});return(0,u.jsxs)(`div`,{style:{maxWidth:720},children:[(0,u.jsxs)(`p`,{style:m,children:[(0,u.jsx)(`code`,{children:`endKeys: ['status']`}),` — the Status column stays pinned to the right edge while the rest scrolls.`]}),(0,u.jsx)(c,{data:d,columns:f,idKey:`id`,plugins:{stickyColumns:e}})]})}},_={render:()=>{let e=o({startKeys:[`name`,`email`],endKeys:[`status`]});return(0,u.jsxs)(`div`,{style:{maxWidth:720},children:[(0,u.jsxs)(`p`,{style:m,children:[(0,u.jsx)(`code`,{children:`startKeys: ['name', 'email']`}),` +`,` `,(0,u.jsx)(`code`,{children:`endKeys: ['status']`}),` — two columns pinned left with cumulative offsets, one pinned right.`]}),(0,u.jsx)(c,{data:d,columns:f,idKey:`id`,plugins:{stickyColumns:e}})]})}},v={render:()=>{let[e,t]=(0,l.useState)({}),n=i({columnWidths:e,columns:f,onColumnResizeEnd:e=>t(t=>({...t,...e}))}),r=o({startKeys:[`name`]});return(0,u.jsxs)(`div`,{style:{maxWidth:720},children:[(0,u.jsxs)(`p`,{style:m,children:[`Resize columns by dragging header edges; the pinned Name column stays sticky. Plugins compose:`,` `,(0,u.jsx)(`code`,{children:`{ columnResize, stickyColumns }`}),`.`]}),(0,u.jsx)(c,{data:d,columns:f,idKey:`id`,plugins:{columnResize:n,stickyColumns:r}})]})}},y={render:()=>{let e=o({});return(0,u.jsxs)(`div`,{style:{maxWidth:720},children:[(0,u.jsxs)(`p`,{style:m,children:[(0,u.jsxs)(`code`,{children:[`useTableStickyColumns(`,`{}`,`)`]}),` — no pinned columns; the table behaves as if the plugin weren't installed.`]}),(0,u.jsx)(c,{data:d,columns:f,idKey:`id`,plugins:{stickyColumns:e}})]})}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => {
