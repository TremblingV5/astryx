import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{B as i,H as a,I as o,R as s,c,t as l,u}from"./Table-CimToFSw.js";import{_ as d,g as f,t as p}from"./Table-BwawNP13.js";function m({indent:e}){let{visibleData:t,treeConfig:n}=c({data:_,idKey:`id`,indent:e,defaultExpandedIds:[`eng`,`eng-platform`,`eng-platform-core`]}),r=u(n);return(0,g.jsxs)(`div`,{children:[(0,g.jsxs)(`p`,{style:{marginBlockEnd:8,fontWeight:600},children:[`indent="`,e,`"`]}),(0,g.jsx)(p,{data:t,columns:v,idKey:`id`,plugins:{tree:r}})]})}var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;t((()=>{h=e(n()),l(),g=r(),_=[{id:`eng`,name:`Engineering`,title:`VP Engineering`,team:`Engineering`,headcount:48,children:[{id:`eng-platform`,name:`Platform`,title:`Director`,team:`Engineering`,headcount:22,children:[{id:`eng-platform-core`,name:`Core Services`,title:`Manager`,team:`Platform`,headcount:12,children:[{id:`eng-platform-core-api`,name:`API Gateway`,title:`Tech Lead`,team:`Core Services`,headcount:5},{id:`eng-platform-core-data`,name:`Data Pipeline`,title:`Tech Lead`,team:`Core Services`,headcount:7}]},{id:`eng-platform-infra`,name:`Infrastructure`,title:`Manager`,team:`Platform`,headcount:10}]},{id:`eng-product`,name:`Product Engineering`,title:`Director`,team:`Engineering`,headcount:26,children:[{id:`eng-product-web`,name:`Web`,title:`Manager`,team:`Product Engineering`,headcount:14},{id:`eng-product-mobile`,name:`Mobile`,title:`Manager`,team:`Product Engineering`,headcount:12}]}]},{id:`design`,name:`Design`,title:`VP Design`,team:`Design`,headcount:11,children:[{id:`design-systems`,name:`Design Systems`,title:`Manager`,team:`Design`,headcount:4},{id:`design-research`,name:`Research`,title:`Manager`,team:`Design`,headcount:7}]},{id:`ops`,name:`Operations`,title:`VP Operations`,team:`Operations`,headcount:6}],v=[{key:`name`,header:`Group`,width:d(2)},{key:`title`,header:`Lead`,width:d(1)},{key:`team`,header:`Parent team`,width:d(1)},{key:`headcount`,header:`Headcount`,width:f(110),align:`end`}],y=v.map(e=>e.key===`name`||e.key===`headcount`?{...e,sortable:!0,sortKey:e.key}:e),b={title:`Core/TableTree`,tags:[`autodocs`]},x={render:()=>{let{visibleData:e,treeConfig:t}=c({data:_,idKey:`id`,defaultExpandedIds:[`eng`]}),n=u(t);return(0,g.jsx)(p,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},S={render:()=>{let{visibleData:e,treeConfig:t,expandAll:n,collapseAll:r}=c({data:_,idKey:`id`,defaultExpandedIds:[`eng`,`eng-platform`,`eng-platform-core`]}),i=u(t);return(0,g.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,g.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,g.jsx)(`button`,{type:`button`,onClick:n,children:`Expand all`}),(0,g.jsx)(`button`,{type:`button`,onClick:r,children:`Collapse all`})]}),(0,g.jsx)(p,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:i}})]})}},C={render:()=>{let{visibleData:e,treeConfig:t}=c({data:_,idKey:`id`,defaultExpandedIds:[`eng`]}),n=u({...t,hasExpandAllControl:!0});return(0,g.jsx)(p,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},w={render:()=>{let{visibleData:e,treeConfig:t}=c({data:_,idKey:`id`,defaultExpandedIds:[`eng`]}),n=u({...t,hasRowClickExpansion:!0});return(0,g.jsx)(p,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},T={render:()=>(0,g.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:32},children:[`sm`,`md`,`lg`].map(e=>(0,g.jsx)(m,{indent:e},e))})},E={render:()=>{let[e,t]=(0,h.useState)(()=>new Set([`design-systems`])),{visibleData:n,treeConfig:r}=c({data:_,idKey:`id`,defaultExpandedIds:[`eng`,`design`]}),{selectionConfig:o}=i({data:n,idKey:`id`,selectedKeys:e,setSelectedKeys:t}),s=u(r),l=a(o);return(0,g.jsx)(p,{data:n,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:s,selection:l}})}},D={render:()=>{let{sortConfig:e,applySort:t}=o({data:_,defaultSort:[{sortKey:`headcount`,direction:`descending`}]}),{visibleData:n,treeConfig:r}=c({data:_,idKey:`id`,defaultExpandedIds:[`eng`,`eng-platform`],sortSiblings:t}),i=u(r),a=s(e);return(0,g.jsx)(p,{data:n,columns:y,idKey:`id`,hasHover:!0,plugins:{sort:a,tree:i}})}},O={render:()=>{let[e,t]=(0,h.useState)([{id:`remote`,name:`Remote team`,title:`Director`,team:`—`,headcount:9}]),[n,r]=(0,h.useState)(()=>new Set),{visibleData:i,treeConfig:a}=c({data:e,idKey:`id`,isItemExpandable:e=>e.id===`remote`,onExpandedIdsChange:n=>{!n.has(`remote`)||e[0].children||(r(new Set([`remote`])),window.setTimeout(()=>{t([{...e[0],children:[{id:`remote-emea`,name:`EMEA`,title:`Manager`,team:`Remote team`,headcount:5},{id:`remote-apac`,name:`APAC`,title:`Manager`,team:`Remote team`,headcount:4}]}]),r(new Set)},600))}}),o=u(a);return(0,g.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:8},children:[(0,g.jsx)(p,{data:i,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:o}}),n.size>0&&(0,g.jsx)(`p`,{children:`Loading children…`})]})}},k={render:()=>{let{visibleData:e,treeConfig:t}=c({data:[{id:`a`,name:`Engineering`,title:`VP Engineering`,team:`—`,headcount:48},{id:`b`,name:`Design`,title:`VP Design`,team:`—`,headcount:11},{id:`c`,name:`Operations`,title:`VP Operations`,team:`—`,headcount:6}],idKey:`id`}),n=u(t);return(0,g.jsx)(p,{data:e,columns:v,idKey:`id`,hasHover:!0,plugins:{tree:n}})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: () => {
    const {
      visibleData,
      treeConfig
