import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{h as n,t as r}from"./Table-CimToFSw.js";import{_ as i,g as a,t as o}from"./Table-BwawNP13.js";function s(e){switch(e.state){case`failed`:return{color:`error`,icon:`error`,label:`Failed`};case`running`:return{color:`warning`,icon:`warning`,label:`Running`};case`queued`:return{color:`gray`,label:`Queued`};default:return null}}var c,l,u,d,f,p,m;e((()=>{r(),c=t(),l=[{id:`j1`,name:`build-core`,owner:`Ava`,state:`failed`},{id:`j2`,name:`lint`,owner:`Liam`,state:`running`},{id:`j3`,name:`unit-tests`,owner:`Zoe`,state:`succeeded`},{id:`j4`,name:`docsite-deploy`,owner:`Max`,state:`queued`},{id:`j5`,name:`smoke-test`,owner:`Mia`,state:`succeeded`}],u=[{key:`name`,header:`Job`,width:i(2)},{key:`owner`,header:`Owner`,width:a(120)},{key:`state`,header:`State`,width:a(120)}],d={title:`Core/TableRowStatus`,tags:[`autodocs`]},f={render:()=>{let e=n({getStatus:s});return(0,c.jsx)(o,{data:l,columns:u,idKey:`id`,hasHover:!0,plugins:{rowStatus:e}})}},p={render:()=>{let e=n({getStatus:e=>e.state===`failed`?{color:`#dc2626`,label:`Failed`}:e.state===`running`?{color:`#f59e0b`,label:`Running`}:null});return(0,c.jsx)(o,{data:l,columns:u,idKey:`id`,hasHover:!0,plugins:{rowStatus:e}})}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: () => {
