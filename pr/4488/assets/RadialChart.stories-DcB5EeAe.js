import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{t as n}from"./Heading-BPCW4A2n.js";import{c as r}from"./Stack-BdU1sgSP.js";import{t as i}from"./Text-gNERuNVk.js";import{s as a}from"./iframe-Cmtkt_0G.js";import{G as o,U as s,V as c,Y as l,ct as u,lt as d,q as f,t as p}from"./src-5u8aMi4H.js";var m,h,g,_,v,y,b,x,S;e((()=>{p(),a(),i(),m=t(),h={title:`Lab/RadialChart`,tags:[`autodocs`]},g=[{model:`Model A`,speed:85,handling:70,comfort:90,safety:95,efficiency:60},{model:`Model B`,speed:70,handling:95,comfort:60,safety:80,efficiency:85},{model:`Model C`,speed:95,handling:60,comfort:75,safety:70,efficiency:90}],_={render:()=>{let e=u().categorical(3);return(0,m.jsxs)(r,{direction:`vertical`,gap:4,children:[(0,m.jsx)(n,{level:3,children:`Spider Chart`}),(0,m.jsxs)(l,{data:g,axes:[`speed`,`handling`,`comfort`,`safety`,`efficiency`],height:400,children:[(0,m.jsx)(f,{rings:5}),(0,m.jsx)(o,{dataKey:`Model A`,color:e[0],dots:!0}),(0,m.jsx)(o,{dataKey:`Model B`,color:e[1],dots:!0}),(0,m.jsx)(o,{dataKey:`Model C`,color:e[2],dots:!0}),(0,m.jsx)(s,{}),(0,m.jsx)(d,{items:[{label:`Model A`,color:e[0]},{label:`Model B`,color:e[1]},{label:`Model C`,color:e[2]}]})]})]})}},v=[{region:`North America`,revenue:42},{region:`Europe`,revenue:28},{region:`Asia Pacific`,revenue:18},{region:`Latin America`,revenue:8},{region:`Africa`,revenue:4}],y={render:()=>{let e=u();return(0,m.jsxs)(r,{direction:`vertical`,gap:4,children:[(0,m.jsx)(n,{level:3,children:`Pie Chart`}),(0,m.jsxs)(l,{data:v,valueKey:`revenue`,labelKey:`region`,height:400,children:[(0,m.jsx)(c,{colors:e.categorical(5)}),(0,m.jsx)(d,{items:v.map((t,n)=>({label:t.region,color:e.categorical(5)[n]}))})]})]})}},b={render:()=>{let e=u();return(0,m.jsxs)(r,{direction:`vertical`,gap:4,children:[(0,m.jsx)(n,{level:3,children:`Donut Chart`}),(0,m.jsxs)(l,{data:v,valueKey:`revenue`,labelKey:`region`,innerRadius:.55,height:400,children:[(0,m.jsx)(c,{colors:e.categorical(5)}),(0,m.jsx)(d,{items:v.map((t,n)=>({label:t.region,color:e.categorical(5)[n]}))})]})]})}},x={render:()=>{let e=u().categorical(2);return(0,m.jsxs)(r,{direction:`vertical`,gap:4,children:[(0,m.jsx)(n,{level:3,children:`Spider with Inner Radius`}),(0,m.jsxs)(l,{data:g,axes:[`speed`,`handling`,`comfort`,`safety`,`efficiency`],innerRadius:.2,height:400,children:[(0,m.jsx)(f,{rings:4}),(0,m.jsx)(o,{dataKey:`Model A`,color:e[0],dots:!0}),(0,m.jsx)(o,{dataKey:`Model B`,color:e[1],dots:!0}),(0,m.jsx)(s,{})]})]})}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  render: () => {
