import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{n as r,t as i}from"./themeProps-_oSbOSxB.js";import{E as a,t as o,x as s}from"./utils-Bk-0w3a3.js";import{t as c}from"./jsx-runtime-DqZldVDK.js";import{n as l}from"./useTooltip-CdbL6YrA.js";import{a as u,t as d}from"./i18n-B1zuuMWC.js";import{n as f,t as p}from"./useDevWarning-ofPmHIP4.js";import{t as m}from"./Tooltip-B1rE8XDl.js";import{n as h,t as g}from"./Field-UzVlsZ6i.js";import{a as _,i as v,n as y,o as b,r as x,t as S}from"./ListItem-DrL4wqnk.js";import{i as C,n as w,r as T,t as E}from"./CheckboxInput-BpGCVQkT.js";function D({label:e,isLabelHidden:t=!1,description:n,status:i,value:o,onChange:s,changeAction:c,density:u=`balanced`,hasDividers:d=!1,isDisabled:f=!1,disabledMessage:p,isReadOnly:m=!1,children:h,ref:_,width:v,xstyle:y,className:b,style:S,"data-testid":C,...w}){let E=(0,O.useId)(),D=(0,O.useId)(),j=(0,O.useId)(),M=(0,O.useId)(),[,N]=(0,O.useTransition)(),P=o!==void 0,[F,I]=(0,O.useOptimistic)(o??A),[L,R]=(0,O.useOptimistic)(null),z=f&&!!p,B=l({placement:`above`,focusTrigger:`always`,isEnabled:z}),V=(0,O.useCallback)((e,t)=>{s?.(e),c&&N(async()=>{I(e),t!==void 0&&R(t),await c(e)})},[s,c,N,I,R]),H=(0,O.useMemo)(()=>({value:P?F:void 0,onChange:P?V:void 0,isDisabled:f,hasDisabledMessage:z,isReadOnly:m,loadingValue:L}),[P,F,V,f,z,m,L]);return(0,k.jsxs)(g,{...w,ref:_,"data-testid":C,label:e,isLabelHidden:t,description:n,inputID:E,labelID:D,isGroupLabel:!0,descriptionID:n?j:void 0,isDisabled:f,status:i?{type:i.type,message:i.message,messageID:i.message?M:void 0}:void 0,statusVariant:`detached`,width:v,xstyle:y,...a(r(`checkbox-list`),{className:b,style:S}),children:[(0,k.jsx)(T,{value:H,children:(0,k.jsx)(`div`,{ref:e=>{B.ref(e)},role:`group`,"aria-labelledby":D,"aria-describedby":[n?j:null,i?.message?M:null,z?B.describedBy:null].filter(Boolean).join(` `)||void 0,children:(0,k.jsx)(x,{density:u,hasDividers:d,children:h})})}),z&&B.renderTooltip(p)]})}var O,k,A,j=e((()=>{O=t(n(),1),h(),v(),m(),o(),i(),C(),k=c(),A=[],D.displayName=`CheckboxList`,D.__docgenInfo={description:`A checkbox group component for multi-value selection.
...
@default false`,defaultValue:{value:`false`,computed:!1}},width:{required:!1,tsType:{name:`union`,raw:`number | string`,elements:[{name:`number`},{name:`string`}]},description:"Width of the field. Numbers are treated as pixels, strings are used as-is\n(e.g. `'100%'`). Sizes the whole field (label, control, and status) so they\nstay aligned, unlike setting width via `xstyle`/`className`/`style`."},children:{required:!0,tsType:{name:`ReactNode`},description:`Checkbox list items to render.`}},composes:[`Omit`]}}));function M({label:e,"aria-label":t,value:n,description:r,endContent:i,isDisabled:a=!1,isLoading:o=!1,isChecked:c,onCheck:l,ref:d,xstyle:p,className:m,style:h,onClick:g,...v}){let y=u(),b=(0,N.use)(T);if(b&&b.value!==void 0&&n===void 0)throw Error("CheckboxListItem requires a `value` prop when used inside CheckboxList with a value array.");let x=t??(typeof e==`string`?e:y(`@astryx.checkboxList.item.checkbox`));f(`CheckboxListItem`,'`label` is a ReactNode, so the checkbox falls back to the generic accessible name "Checkbox". Pass `aria-label` with a concise string equivalent of the visible label so screen readers can tell items apart.',typeof e!=`string`&&t==null);let C=((0,N.use)(_)?.density??`balanced`)===`compact`?`sm`:`md`,w=(b?.isDisabled??!1)||a,D=b?.isReadOnly??!1,O=o||(b?.loadingValue!=null&&n!==void 0?b.loadingValue===n:!1),k=!1;b&&b.value!==void 0&&n!==void 0?k=b.value.includes(n):c!==void 0&&(k=c);let A=!D&&(b!=null||l!=null),j=()=>{w||D||O||(b&&b.value!==void 0&&n!==void 0?b.value.includes(n)?b.onChange?.(b.value.filter(e=>e!==n),n):b.onChange?.([...b.value,n],n):l?.(k!==!0))};return(0,P.jsx)(S,{...v,ref:d,label:e,description:r,endContent:i,isDisabled:w,onClick:A||g?s(g,A?j:void 0):void 0,"aria-busy":O||void 0,xstyle:[k===!0&&!w&&!D&&F.selected,p],className:m,style:h,startContent:(0,P.jsx)(E,{label:x,isLabelHidden:!0,value:k,onChange:()=>j(),isDisabled:w,isReadOnly:D,isLoading:O,size:C})})}var N,P,F,I=e((()=>{N=t(n(),1),o(),p(),w(),y(),b(),C(),d(),P=c(),F={selected:{kWkggS:`astryxgcxg3y`,$$css:!0}},M.displayName=`CheckboxListItem`,M.__docgenInfo={description:`A checkbox item for use within CheckboxList (collection mode)
